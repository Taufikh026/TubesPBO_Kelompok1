 ...
 * @author LENOVO
 */
public class EditProfileDosenGUI extends javax.swing.JFrame {

    /**
     * Creates new form EditProfileDosenGUI
     */
    public EditProfileDosenGUI() {
        initComponents();
    }
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Nama)
                            .addComponent(NIDN, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Kampus)
                            .addComponent(Fakultas, javax.swing.GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE))))
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
            // Mendapatkan nilai dari kolom teks di EditProfileDosenGUI
    String nama = Nama.getText();
    String nidn = NIDN.getText();
    String kampus = Kampus.getText();
    String fakultas = Fakultas.getText();

    // Mengakses ProfileGUI dan mengatur nilai
    ProfileGUI profileGUI = new ProfileGUI();
    profileGUI.setProfileValues(nama, nidn, kampus, fakultas);

    // Menutup EditProfileDosenGUI
    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditProfileDosenGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditProfileDosenGUI().setVisible(true);
            }
        });
    }
